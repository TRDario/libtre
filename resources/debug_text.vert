...
void main() {
    ...
    const vec4 glyphTextColor    = vec4((packedTextColor       & 0xFF) / 255.0,
                                  		...
                                  		(packedTextColor >> 24 & 0xFF) / 255.0);
    const vec4 glyphBGColor      = vec4((packedBGColor       & 0xFF) / 255.0,
                                  		(packedBGColor >> 8  & 0xFF) / 255.0,
                                  		(packedBGColor >> 16 & 0xFF) / 255.0,
                                  		(packedBGColor >> 24 & 0xFF) / 255.0);
